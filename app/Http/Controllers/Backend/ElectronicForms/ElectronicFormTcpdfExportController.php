...
class ElectronicFormTcpdfExportController extends Controller
{
    ...
    /**
     * Export PDF for ElectronicForms using TCPDF
     */
    public function exportPdf()
    {
        try {
            ...
            $pdf->SetTitle('تقرير الاستمارات الالكترونية');
            $pdf->SetSubject('تقرير شامل لـ الاستمارات الالكترونية');
            ...
            $pdf->setRTL(true);
            $pdf->Cell(0, 15, 'تقرير الاستمارات الالكترونية', 0, 1, 'C');
            $pdf->Ln(5);
            ...
            $pdf->Cell(56, 10, 'العنوان', 1, 0, 'C', 1);
            $pdf->Cell(56, 10, 'الوصف', 1, 0, 'C', 1);
            $pdf->Cell(56, 10, 'مفعل', 1, 1, 'C', 1);
            ...
            foreach($data as $item) {
                ...
                $pdf->Cell(56, 8, $item->title ?? 'غير محدد', 1, 0, 'C', 1);
                $pdf->Cell(56, 8, $item->description ?? 'غير محدد', 1, 0, 'C', 1);
                $pdf->Cell(56, 8, $item->active ? 'مفعل' : 'غير مفعل', 1, 1, 'C', 1);
            ...
            return $pdf->Output('تقرير_الاستمارات الالكترونية_' . now()->format('Y_m_d_H_i_s') . '.pdf', 'D');
