        ...
        <div class="navbar navbar-expand-lg landing-navbar px-3 px-md-8">
            ...
            <div class="collapse navbar-collapse landing-nav-menu" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <a class="nav-link link-nav {{ request()->is('/ ') ? 'active' : '' }} fw-medium" aria-current="page"
                            href="{{ Route('home') }}">الرئيسية</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link link-nav fw-medium" href="{{ url('front-pages/landing') }}#landingFeatures">الأخبار</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link link-nav fw-medium" href="{{ url('front-pages/landing') }}#landingTeam">المكتب الخدمي</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link link-nav fw-medium" href="{{ url('front-pages/landing') }}#landingFAQ">المكتبة الصورية</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link link-nav fw-medium" href="{{ url('front-pages/landing') }}#landingContact">المكتبة الفيديوية</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link link-nav fw-medium" href="{{ url('front-pages/landing') }}#landingContact">تواصل معنا</a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ Route('employments') }}" class="nav-link link-nav fw-medium {{ request()->is('Employments') ? 'active' : '' }}">وظائف</a>
                    </li>
                            ...
                            <div class="row gy-4">
                                    ...
                                    <div class="h6 d-flex align-items-center mb-2 mb-lg-4">
                                        <div class="avatar avatar-sm flex-shrink-0 me-2">
                                            <span class="avatar-initial rounded bg-label-primary"><i
                                                    class="icon-base ri ri-layout-grid-line"></i></span>
                                        </div>
                                ...
                                <div class="col-12 col-lg">
                                    <div class="h6 d-flex align-items-center mb-2 mb-lg-4">
                                        <div class="avatar avatar-sm flex-shrink-0 me-2">
                                            <span class="avatar-initial rounded bg-label-primary"><i
                                                    class="icon-base ri ri-lock-unlock-line"></i></span>
                                        </div>
                                        <span class="ps-1">Auth Demo</span>
                                    </div>
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link mega-dropdown-link" href="{{ url('/auth/login-basic') }}"
                                                target="_blank">
                                                <i class="icon-base ri ri-circle-line icon-12px me-2"></i>
                                                Login (Basic)
                                            </a>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link mega-dropdown-link" href="{{ url('/auth/login-cover') }}"
                                                target="_blank">
                                                <i class="icon-base ri ri-circle-line icon-12px me-2"></i>
                                                Login (Cover)
                                            </a>
                                ...
                                <div class="col-12 col-lg">
                                    <div class="h6 d-flex align-items-center mb-2 mb-lg-4">
                                        <div class="avatar avatar-sm flex-shrink-0 me-2">
                                            <span class="avatar-initial rounded bg-label-primary"><i
                                                    class="icon-base ri ri-image-fill"></i></span>
                                        </div>
                                        <span class="ps-1">Other</span>
                                    </div>
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link mega-dropdown-link" href="{{ url('/pages/misc-error') }}"
                                                target="_blank">
                                                <i class="icon-base ri ri-circle-line icon-12px me-2"></i>
                                                Error
                                            </a>
            ...
            <ul class="navbar-nav flex-row align-items-center ms-auto">
                <li class="nav-item">
                    <a class="nav-link p-1" id="nav-theme-1" href="https://www.facebook.com/profile.php?id=61552433883885&mibextid=wwXIfr&rdid=2kls3SPz8j4ygZuh&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2F187haq22aR%2F%3Fmibextid%3DwwXIfr#" target="_blank">
                        <i class="icon-base ri ri-facebook-fill icon-24px"></i>
                        <span class="d-none ms-2" id="nav-theme-text-1">فيسبوك</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link p-1" id="nav-theme-2" href="https://www.instagram.com/atyaf.altimimi?igsh=MXZteDlzZWprY3g5eQ%3D%3D&utm_source=qr" target="_blank">
                        <i class="icon-base ri ri-instagram-line icon-24px"></i>
                        <span class="d-none ms-2" id="nav-theme-text-2">انستكرام</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link p-1" id="nav-theme-3" href="https://wa.me/9647719000600" target="_blank">
                        <i class="icon-base ri ri-whatsapp-line icon-24px"></i>
                        <span class="d-none ms-2" id="nav-theme-text-3">واتساب</span>
                    </a>
                </li>
                @if ($configData['hasCustomizer'] == true)
                    <!-- Style Switcher -->
                    <li class="nav-item dropdown-style-switcher dropdown">
                        <a class="nav-link p-0 ms-5 dropdown-toggle hide-arrow me-sm-2" id="nav-theme" href="javascript:void(0);" data-bs-toggle="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="nav-theme-text">
                            <li>
                                <button type="button" class="dropdown-item align-items-center active"
                                    ...
                                    <span>
                                      <i class="icon-base ri ri-sun-line icon-24px" data-icon="sun-line"></i>
                                      Light
                                    </span>
                                </button>
                            </li>
                ...
                @auth
                    @can('backend')
                        <li class="nav-item">
                            <a class="nav-link p-0" id="nav-theme-4" href="{{ Route('dashboard') }}" target="_blank">
                ...
                {{-- <li>
                    <a href="{{ url('/auth/login-cover') }}" class="btn btn-primary px-2 px-sm-4 px-lg-2 px-xl-4"
                        target="_blank"><span class="icon-base ri ri-user-line me-md-1"></span><span
