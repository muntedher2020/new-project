<div>
      ...
      <div class="d-flex justify-content-between">
        ...
        <div>
          <div class="d-flex gap-2">
            ...
            <button wire:click="deleteSelected" wire:confirm="هل أنت متأكد من حذف الاستمارات المحددة؟"
            ...
            <button {{-- wire:click="$dispatch('openModal', { component: 'electronic-forms.create-electronic-form' })"
              --}} data-bs-toggle="modal" data-bs-target="#createFormModal"
      ...
      <table class="table table-hover">
        ...
        <tbody>
          ...
          <tr>
            <td>
              <div class="form-check">
                <input type="checkbox" class="form-check-input" wire:model="selectedRows" value="{{ $form->id }}">
              </div>
            </td>
            <td>
              <div>
                ...
                <div class="d-flex gap-2 mt-2">
                  ...
                  {{-- @can('formresponse-view') --}}
                  <small class="text-muted">
                    <i class="mdi mdi-file-document"></i>
                    <a href="{{ route('form-responses.index', $form->id) }}" class="text-decoration-none">
                      عرض النتائج
                    </a>
                  </small>
                  {{-- @endcan --}}
            ...
            <td class="text-center">
              <div class="form-check form-switch mt-3">
                <input type="checkbox" class="form-check-input" wire:change="toggleStatus({{ $form->id }})"
                  @checked($form->active)>
            ...
            <td>
              <div class="btn-group btn-group-sm" role="group">
                ...
                <button wire:click="openModal({{ $form->id }})" data-bs-toggle="modal" data-bs-target="#editFormModal"
                ...
                <a href="{{ route('forms.fields.manage', $form->id) }}" class="btn btn-label-info py-1 px-2">
    ...
    <div class="misc-wrapper">
      <div class="card shadow-lg border-0">
        <div class="card-body text-center p-5">
          ...
          <a href="{{ route('dashboard') }}" class="btn btn-primary btn-lg rounded-pill px-5 waves-effect waves-light">
  ...
  {{-- <div class="modal fade" wire:ignore.self id="deleteFormModal" tabindex="-1"
    aria-labelledby="deleteFormModalLabel" aria-hidden="true" wire:model="showDeleteModal">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-danger" wire:click="deleteForm" wire:loading.attr="disabled">
  ...
  {{-- <div class="modal fade" wire:ignore.self id="bulkDeleteModal" tabindex="-1"
    aria-labelledby="bulkDeleteModalLabel" aria-hidden="true" wire:model="showBulkDeleteModal">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <button type="button" class="btn-close" wire:click="closeBulkDeleteModal" aria-label="Close"></button>
        </div>
        <div class="modal-body text-center py-4">
          <div class="mb-3">
