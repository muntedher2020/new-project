<div>
    <!-- Modal التعديل -->
    <div class="modal fade" wire:ignore.self id="editFormModal" tabindex="-1" aria-hidden="true"
         wire:model="isOpen">
                    ...
                    <form wire:submit.prevent="update">
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('title') is-invalid @enderror" 
                                           id="edit_title" wire:model="title">
                                    @error('title')
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <input type="datetime-local" class="form-control @error('end_date') is-invalid @enderror" 
                                                   id="edit_end_date" wire:model="end_date">
                                        </div>
                                    </div>
                                    @error('start_date')
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" 
                                               id="edit_active" wire:model="active">
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" 
                                               id="edit_require_login" wire:model="require_login">
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" 
                                               id="edit_allow_multiple" wire:model="allow_multiple">
                                    ...
                                    <div class="alert alert-info">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <a href="{{ route('forms.public.show', $formSlug) }}" 
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary" 
                                ...
                                <span wire:loading>
                                    <i class="mdi mdi-loading mdi-spin"></i> جاري التحديث...
                                </span>
                            </button>
                        </div>
                    </form>
