<!-- Remove ElectronicForm Modal -->
<div wire:ignore.self class="modal fade" id="removeelectronicformModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="p-4 modal-content">
            ...
            <div class="modal-body">
                ...
                <hr class="mt-n2">
                <div wire:loading.remove wire:target="destroy, GetElectronicForm">
