...
use App\Http\Controllers\Backend\ElectronicForms\FormResponsesController;
use App\Http\Controllers\Backend\ElectronicForms\FormResponsesPrintController;
use App\Http\Controllers\Backend\ElectronicForms\FormResponsesTcpdfExportController;
...
Route::middleware(['auth', 'verified'])->group(function () {
  ...
  Route::middleware(['role:OWNER|Admin'])->group(function () {
    Route::GROUP(['prefix' => 'Backend'], function () {
      ...
      // Routes نتائج الاستمارات
      Route::prefix('Electronic-Forms/{formId}/Responses')->group(function () {
        Route::get('/', [FormResponsesController::class, 'index'])->name('form-responses.index');
        Route::get('/{responseId}', [FormResponsesController::class, 'show'])->name('form-responses.show');
        Route::put('/{responseId}', [FormResponsesController::class, 'update'])->name('form-responses.update');
